...
one_year_forecast = st.sidebar.number_input(
    "1-Year Forecast Growth (%)", min_value=0.0, value=30.0, step=0.1)
...
bonds = st.sidebar.number_input(
    "Current Bonds Value (₹)", min_value=0.0, value=1121.0, step=100.0)

tickertape = st.sidebar.number_input(
    "Current Investments (e.g. Stocks, Mutual funds) (₹)", min_value=0.0, value=10000.0, step=1000.0)

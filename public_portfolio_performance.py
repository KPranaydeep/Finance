...
with st.container(border=True):
    st.markdown("**See what happened after each security entered the published portfolio.**")
    st.caption("Publication-linked history against Nifty 50 and VT world, with INR-aware overseas returns.")
    st.page_link(
        "pages/03_Public_Track_Record.py",
        label="Open portfolio track record",
